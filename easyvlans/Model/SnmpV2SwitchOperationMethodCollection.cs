...
{
    internal class SnmpV2SwitchOperationMethodCollection : SnmpSwitchOperationMethodCollectionBase
    {

        private const string CODE = "snmpv2";

        public class Factory : ISwitchOperationMethodCollection.IFactory
        {
            ...
            public ISwitchOperationMethodCollection GetInstance(XmlNode configNode, Switch @switch)
            {
                ...
                return new SnmpV2SwitchOperationMethodCollection(@switch, ip, port, communityString, accessVlanMembershipMethod, persistChangesMethod);
            }
