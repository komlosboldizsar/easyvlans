...
namespace easyvlans.Logger
{
    ...
    {
        public delegate void LogMessageDelegate(LogMessageSeverity severity, string message);
        public static event LogMessageDelegate LogMessage;
        public static void Log(LogMessageSeverity severity, string message) => LogMessage?.Invoke(severity, message);
