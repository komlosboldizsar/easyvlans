    ...
    public partial class MainForm
    {
        private class PortRowManager : RowManagerBase<Port>
        {
            ...
            public override void SubscribeControlEvents()
            {
                ...
                _setVlanToComboBox.MouseDown += setVlanToComboBoxMouseDownHandler;
                _setVlanToComboBox.DrawMode = DrawMode.OwnerDrawFixed;
                _setVlanToComboBox.DrawItem += setVlanToComboBoxDrawItemHandler;
            ...
            private void setVlanToComboBoxMouseDownHandler(object sender, MouseEventArgs e)
            {
                if (e.Button == MouseButtons.Right)
                {
                    if (Item.DefaultVlan != null)
                        _setVlanToComboBox.SelectByValue(Item.DefaultVlan);
                }
            }

            private void setVlanToComboBoxDrawItemHandler(object sender, DrawItemEventArgs e)
            {
                if (e.Index == -1)
                    return;
